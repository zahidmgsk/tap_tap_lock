...
class CombinedWidgetVertical : AppWidgetProvider() {
    ...
    companion object {
        internal fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            val views = RemoteViews(context.packageName, R.layout.lock_disable_vertical_layout)
            ...
            val lockPendingIntent = PendingIntent.getBroadcast(
                context, appWidgetId + 8000, lockIntent,
            ...
            val disablePendingIntent = PendingIntent.getActivity(
                context, appWidgetId + 9000, disableIntent,
                PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
            )
